...
//		inquiry.setEmail("unko4@example.com");
//		inquiry.setContents("Hello Unko!");
//		
...
//		}
	...
	@PostMapping("/confirm")
	public String confirm(@Validated InquiryForm inquiryFrom,
	...
	public String complete(@Validated InquiryForm inquiryForm,
		...
		redirectAttibutes.addFlashAttribute("complete", "Registered!");

		return "redirect:/inquiry/form";
	}
	
//	@ExceptionHandler(InquiryNotFoundException.class)
//	public String handleException(InquiryNotFoundException e, Model modle) {
